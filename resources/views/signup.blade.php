    ...
    <div class="jumbotron-fluid float-lg-center text-dark">
        <div class="container-fluid">
            ...
            <form action="{{ route('usuario_registro') }}" method="POST">
                ...
                <button type="submit" class="btn-block submit-button">Registrarse</button>
            </form>
            <hr>
            <label for="login">¿Tienes cuenta?</label> <br>
            <a role="button" id="login" class="btn btn-outline-dark" type="text" href="{{route('display_login')}}">inicia sesión</a>
            <br>
        </div>
    </div>
<!--/.Content-->
